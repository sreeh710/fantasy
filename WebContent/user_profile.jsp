  ...
  <div style="float:right;" width="40%">
      <% 
            ...
            ResultSet resultset4 = 
                statement4.executeQuery("select * from match where status ='"+status+"' and team_id = (select team_id from user where username = '"+userName+"') ");
            
            if(resultset4.next()){    
            %>
            
            <h2>display score card and other informatio</h2>
